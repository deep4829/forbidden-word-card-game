...
export default function GamePage() {
  ...
  // NEW: Track if How to Play modal is open
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
          ...
          <div className="fixed bottom-6 right-6 z-[1000] space-y-3 pointer-events-auto">
            ...
            <button
              ...
              className="w-16 h-16 rounded-full shadow-2xl flex items-center justify-center text-2xl bg-indigo-600 text-white ring-4 ring-indigo-300 hover:bg-indigo-700 transition-all"
